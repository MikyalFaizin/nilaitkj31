...
<head>
    ...
    <title>Aplikasi Nilai by Mikyal Faizin</title>
    <link rel="shortcut icon" href="images/tkjl.jpg" type="image/x-icon">
    ...
    <div class="card">
        <div class="card-body bg-info">
            ...
            <span class="float-end">
             Versi 1.0 by <a href="http://tkj012.rf.gd/?i=1" target="blank" rel="noopener noreferrer">Mikyal Faizin</a>
            </span>
        </div>
    </div>
</div>
